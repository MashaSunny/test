...
namespace Test
{
    public class Base  : IDisposable
    {
        ...
        public string
            Site = "http://gama-gama.ru",
            Logo = "gg-logo",
            Login = "burylov.artem@yandex.ru",
            Password = "qwerty123",
            InputLogin = "//input[@class='auth_form_login']",
            InputPassword = "//input[@class='auth_form_pass']",
            EntryCite = "//a[text()='Вход']",
            EntryForm = "//button[text()='Войти']",
            RegistrationForm = "//a[text()='Создать аккаунт']",
